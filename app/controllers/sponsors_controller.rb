class SponsorsController < ApplicationController
  ...
  def sponsor_params
    params.require(:sponsor).permit(:name, :branch, :status, :type, :organization_id, :gender, :address, :country, :partnership_start_date, :email, :contact_1, :contact_2, :additional_info, :osra_id)
  end
end
